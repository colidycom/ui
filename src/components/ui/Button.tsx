    ...
    (
        ...
        const classes: {
            ...
            colors: {
                ...
                outline: `backdrop-blur border border-${color}-500/40 hover:bg-${color}-500/20 shadow-sm active:bg-${color}-500/30 text-${color}-900 dark:text-${color}-50`,
        ...
        return (
            <button {...combinedProps} disabled={disabled}>
                {isLoading ? (
                    <svg
