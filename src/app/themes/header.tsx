...
export default function Header({
    ...
    return (
        <>
            <div className="w-full bg-black/5 dark:bg-white/5 relative px-5">
                <section className="container py-40 flex flex-col items-center">
                    ...
                    <div className="flex mt-4 items-center gap-4">
                        <Popover>
                            ...
                            <PopoverContent forceMount align="center">
